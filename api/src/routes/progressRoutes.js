...
import { postLessonProgress, getLessons, postExamResult, getExamAttempts, getSummary, getSummaryPublic, getStudentProgress } from '../controllers/progressController.js';

const router = express.Router();

router.post('/lesson', requireAuth, postLessonProgress);
router.get('/lessons/me', requireAuth, getLessons);
router.get('/student/:id', getStudentProgress); // Nova rota admin
